...
test_deny_non_whitelisted_service_account { 
    admission.deny["pod serviceAccount \"default\" with image \"banzaicloud/pipeline\" is not allowed"] with input as {
        "request": {
            "operation": "CREATE",
            "kind": {"kind": "Pod"},
            "namespace": "default",
...
test_deny_whitelisted_service_account_with_non_whitelisted_image {
    admission.deny["pod serviceAccount \"banzaicloud\" with image \"banzaicloud/not-allowed-app\" is not allowed"] with input as {
        "request": {
            "operation": "CREATE",
            "kind": {"kind": "Pod"},
            "namespace": "default",
